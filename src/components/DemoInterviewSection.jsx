  ...
  const features = [
    {
      ...
      description:
        "Explore the latest job openings from companies and recruiters across different industries and locations.",
    },
    {
      icon: <FaBriefcase />,
      title: "Complete Job Details",
      description:
        "Check important information such as salary, experience, skills, location, job type, and company details.",
    },
    {
      icon: <FaCheckCircle />,
      title: "Free Job Browsing",
      description:
        "Browse available jobs without creating an account or paying any charges.",
    },
    {
      icon: <FaExternalLinkAlt />,
      title: "Apply Directly",
      description:
        "Found the right opportunity? Click Apply and continue to the provided application link.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              Find Your Next
              <span className="text-emerald-400"> Job Opportunity</span>
            </motion.h2>
            ...
            <motion.p
              ...
              className="text-slate-400 text-lg mt-6 leading-8"
            >
              Discover job opportunities from companies and recruiters,
              explore complete job details, and apply for the positions that
              match your skills and experience. No account is required to
              browse jobs.
            </motion.p>
