...
export default function RecentJobs() {
  ...
  if (loading) {
    return (
     <section className="bg-slate-950 py-20 min-h-screen flex flex-col justify-center items-center">

  {/* Loader */}
  <div className="relative">
    <div className="w-20 h-20 rounded-full border-4 border-slate-700"></div>

    <div className="absolute top-0 left-0 w-20 h-20 rounded-full border-4 border-transparent border-t-emerald-500 border-r-emerald-400 animate-spin"></div>
  </div>

  <h2 className="text-white text-xl sm:text-2xl font-semibold mt-8">
    Loading Jobs...
  </h2>
  ...
  const featured = jobs.length > 0 ? jobs[0] : null;
    ...
    <section className="bg-slate-950 py-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex justify-between items-center mb-8">
              <h2 className="text-4xl font-bold text-white">Recent Jobs</h2>
                ...
                >
                  <div className="flex flex-col md:flex-row justify-between gap-6">
                    <div className="flex gap-5">
                      <img
                        src={
                          job.companyLogo || "https://via.placeholder.com/80"
                        }
                        alt={job.companyName}
                        className="w-16 h-16 rounded-xl bg-white object-contain p-2"
                      />
            ...
            <div className="text-center mt-10">
              <Link
                to={"/all-jobs"}
                className="bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-4 rounded-xl font-semibold transition"
              >
                Browse All Jobs
              </Link>
            </div>
          ...
          <div>
            <h2 className="text-4xl font-bold text-white mb-8">Featured Job</h2>

            <div className="bg-slate-900 rounded-2xl border border-slate-800 p-8 sticky top-24">
              <img
                src={featured?.companyLogo || "https://via.placeholder.com/100"}
                className="w-20 h-20 bg-white rounded-xl p-3"
              ...
              <p className="text-emerald-400 mt-2">{featured?.companyName}</p>
              ...
              <div className="space-y-4 mt-8 text-slate-400">
                ...
                <p className="flex items-center gap-3">
                  <FaMoneyBillWave />₹{featured?.salaryMin?.toLocaleString()} -
              ...
              <p className="text-slate-400 mt-8 leading-7">
                Join one of the world's leading technology companies and work on
                modern web applications using React, TypeScript, and cloud
                technologies.
              </p>
