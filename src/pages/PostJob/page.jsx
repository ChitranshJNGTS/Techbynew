...
export default function PostJob() {
  ...
  return (
    <section className="bg-gray-50 min-h-full py-10">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-10">
          ...
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-emerald-50 border border-emerald-100 text-emerald-600 font-semibold text-sm">
            Recruiter Portal
          </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Google"
                    className="w-full bg-white border border-gray-300 rounded-xl px-5 py-3.5 text-gray-900 placeholder-gray-400 outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    accept="image/*"
                    onChange={handleFileChange}
                    className="w-full bg-gray-50 border border-gray-300 rounded-xl px-4 py-2.5 text-gray-700 file:bg-emerald-500 file:border-0 file:px-4 file:py-2 file:rounded-lg file:text-white file:mr-4 file:cursor-pointer"
                  />
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="Enter complete office address..."
                    className="w-full bg-white border border-gray-300 rounded-xl px-5 py-3.5 text-gray-900 placeholder-gray-400 resize-none outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition"
                  />
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 md:p-8 shadow-sm">
              ...
              <p className="text-gray-500 text-sm mt-2">
                Candidates will be redirected to this link when they
                click Apply Now.
              </p>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 md:p-8 shadow-sm">
              ...
              <div className="flex items-center gap-3 mb-7">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Add hiring timeline and vacancies
                  </p>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm  lg:top-6">
              ...
              <ul className="space-y-4 text-gray-600">
                ...
                <li className="flex gap-3">
                  <span className="text-emerald-500">✓</span>
                  Mention an accurate salary range.
                </li>

                <li className="flex gap-3">
                  <span className="text-emerald-500">✓</span>
                  Add all required technical and soft skills.
                </li>

                <li className="flex gap-3">
                  <span className="text-emerald-500">✓</span>
                  Write a detailed job summary and responsibilities.
                </li>

                <li className="flex gap-3">
                  <span className="text-emerald-500">✓</span>
                  Include application deadline and joining date.
                </li>

                <li className="flex gap-3">
                  <span className="text-emerald-500">✓</span>
                  Highlight company culture and employee benefits.
                </li>
            ...
            <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-6">
              ...
              <ul className="space-y-3 text-gray-600 text-sm">
                ...
                <li>
                  ✓ Double-check salary and location.
                </li>
                ...
                <li>
                  ✓ Ensure job requirements are complete.
                </li>
