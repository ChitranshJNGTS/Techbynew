      ...
      <>
        ...
        <div className="min-h-screen bg-slate-950 flex items-center justify-center">
          <div className="text-center">
            <div className="w-12 h-12 border-4 border-emerald-500 border-t-transparent rounded-full animate-spin mx-auto mb-5"></div>
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                ...
                <div className="flex flex-col items-center lg:items-end gap-5">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 px-6 py-3 rounded-xl text-white transition"
                  >
                    <FaUserEdit />
          ...
          <div className="bg-slate-900 rounded-2xl w-full max-w-3xl p-8 border border-slate-700">
            ...
            <div className="flex justify-end gap-4 mt-8">
              ...
              <button
                ...
                disabled={saving}
                className="px-6 py-3 rounded-lg bg-emerald-500 hover:bg-emerald-600 disabled:opacity-60 text-white"
              >
                {saving
                  ? "Saving..."
                  : "Save Changes"}
